...
const AppRoutes = () => (
  <Router>
    <Routes>
      ...
      <Route path="/payments/:id" element={<PrivateRoute><ViewDetails /></PrivateRoute>} />
      <Route path="/payments/:id/edit" element={<PrivateRoute><AddPayment mode="edit" /></PrivateRoute>} />
