...
const LoginPage = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === 'identifier') {
      ...
      else if (value.includes('@') && !isValidEmail(value)) message = 'Email is invalid format.';
    }
    if (name === 'password') {
  ...
  const validateForm = () => {
    ...
    else if (identifier.includes('@') && !isValidEmail(identifier)) errors.identifier = 'Email is invalid format.';
              ...
              <Form onSubmit={handleSubmit} noValidate>
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  <Button variant="primary" type="submit" style={{ flex: 1 }} disabled={loading}>
                    {loading ? (<><Spinner size="sm" animation="border" className="me-2" />Logging in...</>) : 'Login'}
                  </Button>
